...
class CloudSqlCredential(BaseModel):
    password: Optional[str] = Field(
        None, description='The password for the credential.'
    )
    username: Optional[str] = Field(
        None, description='The username for the credential.'
    )
...
class CloudSqlProperties(BaseModel):
    credential: Optional[CloudSqlCredential] = Field(
        None, description='Input only. Cloud SQL credential.'
    )
...
class Connection(BaseModel):
    cloudSql: Optional[CloudSqlProperties] = Field(
        None, description='Cloud SQL properties.'
    )
    creationTime: Optional[str] = Field(
        None, description='Output only. The creation timestamp of the connection.'
    )
    description: Optional[str] = Field(None, description='User provided description.')
    friendlyName: Optional[str] = Field(
        None, description='User provided display name for the connection.'
    )
    ...
    lastModifiedTime: Optional[str] = Field(
        None, description='Output only. The last update timestamp of the connection.'
    )
...
class ConnectionCredential(BaseModel):
    cloudSql: Optional[CloudSqlCredential] = Field(
        None, description='Credential for Cloud SQL database.'
    )
...
class ListConnectionsResponse(BaseModel):
    connections: Optional[List[Connection]] = Field(
        None, description='List of connections.'
    )
